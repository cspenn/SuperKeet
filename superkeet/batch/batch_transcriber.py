...
from superkeet.batch.audio_converter import AudioConverter
from superkeet.batch.file_processor import FileProcessor
from superkeet.config.config_loader import config
from superkeet.utils.exceptions import ASRError, FileOperationError
...
class BatchTranscriptionWorker(QThread):
    ...
    def _format_json_output(
        ...
        output_data = {
            ...
            "processing_info": {
                "model": config.get(
                    "asr.asr_model", "mlx-community/parakeet-tdt-0.6b-v2"
                ),
                "sample_rate": 16000,
                "channels": 1,
            },
